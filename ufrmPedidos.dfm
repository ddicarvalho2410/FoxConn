inherited frmPedidos: TfrmPedidos
  ...
  inherited dtsCadastro: TDataSource
    DataSet = dmPrincipal.cdsPedidos
  end
  object dtsPedidos_Itens: TDataSource
    DataSet = dmPrincipal.cdsPedidos_Itens
    Left = 376
    Top = 440
  end
end
